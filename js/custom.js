...
$(document).ready(function () {
    ...
    $('#btn-content-load').click(function () {
        if ($('#player-username').val() == '') {
        	alert('Te rugam sa introduci un nume de utilizator valid!');
        	return;
        }
    ...
    function Process1() {
        ...
        setTimeout(function () {
            $('#content1').html('Se conecteaza la baza de date tiktok.com');
            $('#content1').fadeIn(100);
            setTimeout(function () {
                $('#content1').html('Se cauta utilizatorul ' + username + '');
                setTimeout(function () {
                    $('#content1').html('Utilizator Gasit!');
                    setTimeout(function () {
    ...
    function Process2() {
        setTimeout(function () {
            $('#beforeVer').html('<p style="margin:0;">Monedele sunt in procesare!</p>').fadeIn(500);
            setTimeout(function () {
                hideLoader();
                ...
                $('#beforeVer').html('<p style="margin:0;color:red">Asteapta maxim 24h</p>').fadeIn(500);
                setTimeout(function () {
                    $('#beforeVer').html('<p style="margin:0;color:#d7ce66">Pentru a primi monedele in cont.</p>');
